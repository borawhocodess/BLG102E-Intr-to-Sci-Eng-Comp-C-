...
char *my_strcpy(char *dest, char *source); // "" = "abc" 
char *my_strcat(char *dest, char *source); // "abc" + "xyz" = "abcxyz"
...
void generate_email(char *name, char *surname, int year)
{
    ...
    // e-mail format 1
    my_strcat(candidate1, substr(dest, name, 0, 1));
